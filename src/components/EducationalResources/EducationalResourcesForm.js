...
class EducationalResourcesForm extends Component {
    ...
    return (
      ...
      >
        <Field
          ...
          label={"Educational Resource Name"}
        />
        <Field
          name="topic_id"
          component={this.renderInput}
...
const validate = (formValues) => {
  const errors = {};
  if (!formValues.name) {
    errors.name = "Please, enter a valid Educational Resource name";
  }
