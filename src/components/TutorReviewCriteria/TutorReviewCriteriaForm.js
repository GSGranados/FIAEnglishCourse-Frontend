...
class TutorReviewCriteriaForm extends Component {
    ...
    return (
      ...
      >
        <Field
          ...
          label={"Tutor Review Criteria Name"}
        />
...
const validate = (formValues) => {
  const errors = {};
  if (!formValues.name) {
    errors.name = "Please, enter a valid Tutor Review Criteria name";
  }
